...
## The goal of this exercise is to build and evaluate your first predictive model. You will use the n-gram and 
## backoff models you built in previous tasks to build and evaluate your predictive model. The goal is to make the 
## model efficient and accurate.
...
## Quatr/Tri/Bi/Unigrams_completed.RData > ngrams_completed_matrix.Rdata ##
## ========================================================== ##
...
## ngrams_completed_matrix > nGrams_model.Rdata ##
## ========================================================== ##
